...
PROGMEM prog_uint16_t pose_10[] = {18, 248, 781, 258, 755, 463, 547, 354, 661, 512, 512, 507, 525, 492, 502, 523, 514, 468, 474};
PROGMEM prog_uint16_t pose_5[] = {18, 238, 766, 262, 757, 468, 548, 359, 674, 512, 512, 492, 498, 517, 501, 495, 497, 509, 501};

PROGMEM transition_t camina[] = {{0,9} ,{pose_2,300} ,{pose_3,300} ,{pose_4,300} ,{pose_5,300} ,{pose_6,300} ,{pose_7,300} ,{pose_8,300} ,{pose_9,300} ,{pose_10,300} };
