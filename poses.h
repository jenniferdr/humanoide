...
//PROGMEM prog_uint16_t pose_1[] = {204, 812, 265, 757, 468, 548, 360, 672, 512, 512, 508, 507, 512, 501, 518, 507, 510, 506};
...
PROGMEM prog_uint16_t pose_10[] = {18,251, 782, 258, 755, 468, 548, 355, 661, 512, 512, 508, 533, 492, 503, 523, 521, 468, 459};

PROGMEM transition_t camina[] = {{0,9} , {pose_2,300 } , {pose_3,300} , {pose_5,300} , {pose_6,300} , {pose_7,300} , {pose_8,300} , {pose_9,300} , {pose_10,300} , {pose_11,300}, {pose_2,300}};
