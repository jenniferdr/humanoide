...
Para llegar a la pelota el robot debe hacerlo por medio de aprendizaje de m\'aquinas especificamente por reforzamiento, para esto se debe hacer la implementación del algoritmo de planificación de acciones que lleve al humanoide a acercarse a la pelota; una fase de entrenamiento y una fase de pruebas de desempe\~no. 
% con el aprendizaje y la utilizaci\'on de Aprendizaje Q  y un posterior entrenamiento y realizaci\'on de pruebas de desempe\~no. F
