...
\input{desarrollo/1_Tecnologias_utilizadas.tex}
\input{desarrollo/2_Integracion_de_componentes.tex}
\input{desarrollo/3_Movimientos.tex}
\input{desarrollo/4_vision_del_robot.tex}
