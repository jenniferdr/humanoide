...
% Pagina de titulo
\input{intro/portada1.tex}
\input{intro/portada.tex}


% Pagina de acta final (vacio)
\input{acta.tex}
\includegraphics[width=\textwidth, height=\textheight]{acta.jpg}
\includegraphics[width=\textwidth, height=\textheight]{acta1.jpg}
...
\input{marco_teorico/1_robotica.tex}
\input{marco_teorico/2_Inteligencia_Artificial.tex}
\input{marco_teorico/3_Vision_Artificial.tex}


\input{desarrollo/0_introAdesarrollo.tex}
\input{desarrollo/1_diseno.tex}

\input{desarrollo/2_deteccion.tex}
\input{desarrollo/3_busqueda.tex}

\input{desarrollo/4_aprendizaje.tex}

\input{desarrollo/6_deteccionCaidas.tex}
\input{desarrollo/7_arco.tex}
\input{desarrollo/5_resultados.tex}
...
%\input{apendices/glosario.tex}
\input{desarrollo/5_consideraciones.tex}
\input{apendices/carta.tex}
\clearpage
