...
#define GetTorqueL(id) (ax12GetRegister(id,AX_MAX_TORQUE_L, 2))
#define SetTorqueL(id, tor) (ax12SetRegister2(id,AX_MAX_TORQUE_L, tor))
#define GetTorqueH(id) (ax12GetRegister(id,AX_MAX_TORQUE_H, 2))
#define SetTorqueH(id, tor) (ax12SetRegister2(id,AX_MAX_TORQUE_H, tor))
